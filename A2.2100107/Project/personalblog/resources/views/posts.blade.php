        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 400px; overflow:hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" alt="{{ $posts[0]->category->slug }}"
                        class="card-img-top">
                </div>
            @else
                <img src="https://picsum.photos/seed/{{ $posts[0]->category->slug }}/1200/400"
                        ...
                        <div class="card">
                            ...
                            @if ($post->image)
                                <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->category->slug }}"
                                    class="card-img-top">
                            @else
                                <img src="https://picsum.photos/seed/{{ $post->category->slug }}/500/400"
