...
<body>
    ...
    <nav>
        ...
        <ul class="menu-nav">
            ...
            <li class="nav-links"><a class="active" href="kegiatan.php">JADWAL</a></li>
        </ul>
    ...
    <!-- SECTION INFORMATION KEGIATAN -->
    <div class="card m-5 p-3 mx-6">
        <div class="card-header">
            <div class="card-header text-white bg-secondary">
                <h6>Jadwal Kegiatan Anggota SIJADKAMLING</h6>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach ($jadwal as $row) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Ubah.php?id=<?= $row["id"]; ?>" class="btn btn-success"><i class="ri-delete-bin-6-line"></i>Ubah</a>
                                <a href="delete.php?id=<?= $row["id"]; ?>" class="btn btn-danger"><i class="ri-delete-bin-6-line"></i>Hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
